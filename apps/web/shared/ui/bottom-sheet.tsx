...
export function BottomSheet({ isOpen, onClose, title, children }: BottomSheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      {/* 시트 */}
      <div
        className="absolute bottom-0 left-0 right-0 max-w-4xl mx-auto bg-background rounded-t-2xl max-h-[80vh] flex flex-col animate-in slide-in-from-bottom duration-300"
        onTouchStart={(e) => {
